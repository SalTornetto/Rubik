...
from trainingDataGenerator import generate_test_data_with_inverses  # Import data generator
...
numMoves = 2  # The number of moves trained cubes will be shuffled by
